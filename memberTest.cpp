...
public:
    ...
    Member(string u = "", string p = "", string fname = "", int phone = 0, string mail = "", string id = "", float rating = 3.0, int creditPoints = 0)
        : User(u, p, fname, phone, mail, id, rating, creditPoints) {}
